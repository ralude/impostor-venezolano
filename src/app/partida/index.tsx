    ...
    <ScreenLayout>
      <View className="w-full max-w-xl flex-1 self-center px-6 pt-4">
        ...
        <Text className="mt-1 text-base text-on-surface-variant">
          Agrega al menos {MIN_JUGADORES} jugadores
        </Text>
        ...
        <ScrollView className="mt-6 flex-1" showsVerticalScrollIndicator={false}>
          {jugadores.length === 0 ? (
            <Text className="mt-8 text-center text-base text-on-surface-variant">
              Aún no hay jugadores. Agrega el primero arriba.
            </Text>
          ) : (
      ...
      <View className="w-full max-w-xl self-center px-6 pb-6">
        ...
        <Button
          ...
          className={jugadores.length < MIN_JUGADORES ? 'opacity-40' : ''}
        />
      </View>
    </ScreenLayout>
  );
